...
$sql_time = "SELECT time FROM usuarios WHERE email = '$email'";
...
$sql_usuarios = "SELECT * FROM usuarios WHERE time = '$time'";
  ...
  <body>
    ...
    <tbody>
      <?php while($row = mysqli_fetch_assoc($result_usuarios)): ?>
        ...
        <td><img src="<?php echo $row['foto']; ?>" alt="<?php echo $row['nome']; ?>"></td>
